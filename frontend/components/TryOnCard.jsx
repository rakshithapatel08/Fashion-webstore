...
const TryOnCard= ({ product }) => {
  ...
  return (
    <Flex flexDirection="column" borderRadius="0 0 5px 5px" color="whiteAlpha.900" bgGradient="linear(to-br, whiteAlpha.700, whiteAlpha.400)" cursor="pointer" onClick={() => {setData(tryOn(product.garment_id, product.gender))}}>
